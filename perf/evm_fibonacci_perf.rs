...
use revm_interpreter::interpreter_types::{Jumps, LoopControl, StackTr};
use revm_interpreter::{instruction_table, CallInput, InputsImpl, Interpreter, SharedMemory};
...
pub fn main() {
    ...
    for _ in 0..1000 {
        ...
        interpreter.bytecode.absolute_jump(0);
