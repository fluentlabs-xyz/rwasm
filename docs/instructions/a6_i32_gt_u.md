...
The `i32_gt_u` instruction **compares two 32-bit integers for unsigned greater-than**. It pops two 32-bit integers from the stack, interprets them as unsigned integers, and pushes 1 if the first operand is greater than the second, or 0 otherwise.
