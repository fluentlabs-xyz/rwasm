...
The `i32_lt_s` instruction **compares two 32-bit integers for signed less-than**. It pops two 32-bit integers from the stack, interprets them as signed integers, and pushes 1 if the first operand is less than the second, or 0 otherwise.
