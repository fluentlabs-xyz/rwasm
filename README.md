...
| Wide arithmetic                           | phase 4   | implemented     | since 0.7.0: `i64.mul_wide_s/u`, `i64.add128`, `i64.sub128` lower to the `I64MulWideS/U`, `I64Add128`, `I64Sub128` opcodes, the widening multiply and carry that 256-bit and 384-bit arithmetic lacks on wasm32; build guests with `-C target-feature=+wide-arithmetic` |
