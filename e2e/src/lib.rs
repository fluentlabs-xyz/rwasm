...
define_spec_tests! {
    ...
    // fn wasm_bulk("bulk");
    // fn wasm_call("call");
    fn wasm_call_indirect("call_indirect"); // FAILED
    ...
    // fn wasm_return_call_indirect("proposals/tail-call/return_call_indirect"); // FAILED
    ...
    // fn wasm_func("func"); // FAILED
    // fn wasm_func_ptrs("func_ptrs"); // FAILED
    ...
    // fn wasm_left_to_right("left-to-right"); // FAILED
