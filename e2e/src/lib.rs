...
define_spec_tests! {
    ...
    // fn wasm_bulk("bulk");  // NOT WORKING (data drop)
    // fn wasm_call("call");
    // fn wasm_call_indirect("call_indirect");
    // fn wasm_extended_const_data("proposals/extended-const/data");
    // // fn wasm_extended_const_elem("proposals/extended-const/elem"); // NOT WORKING (wast)
    ...
    // // fn wasm_comments("comments"); // NOT WORKING (wast)
    // fn wasm_const("const");
    // fn wasm_conversions("conversions");
    // fn wasm_custom("custom");
    // fn wasm_data("data");
    // // fn wasm_elem("elem"); // NOT WORKING (wast)
    ...
    // fn wasm_i64("i64");
    // fn wasm_if("if");
    // // fn wasm_imports("imports"); // NOT WORKING (wast)
