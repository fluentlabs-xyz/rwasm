...
define_spec_tests! {
    ...
    // fn wasm_extended_const_elem("proposals/extended-const/elem"); // NOT WORKING (imported tables)
    ...
    // fn wasm_elem("elem"); // NOT WORKING (imported tables)
    ...
    // fn wasm_table("table"); // NOT WORKING (imported table)
