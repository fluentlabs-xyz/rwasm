...
///
/// Types that implement this trait can automatically be converted to `rwasm::Error` and
/// `rwasm::Trap` and will be represented as a boxed `HostError`. You can then use the various
/// methods on `rwasm::Error` to get your custom error type back
