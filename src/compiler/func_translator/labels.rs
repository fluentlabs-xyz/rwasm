use crate::{BranchOffset, RwasmError};
use alloc::vec::Vec;
use core::{
    fmt::{self, Display},
...
impl LabelUser {
    ...
    pub fn new(label: LabelRef, user: u32) -> Self {
        Self { label, user }
    }
}
...
pub enum LabelError {
    ...
    AlreadyPinned { label: LabelRef, pinned_to: u32 },
...
impl LabelRegistry {
    ...
    pub fn pin_label(&mut self, label: LabelRef, instr: u32) -> Result<(), LabelError> {
    ...
    pub fn try_pin_label(&mut self, label: LabelRef, instr: u32) {
    ...
    pub fn try_resolve_label(
        ...
        label: LabelRef,
        user: u32,
    ) -> Result<BranchOffset, RwasmError> {
    ...
    fn resolve_label(&self, label: LabelRef) -> Result<u32, LabelError> {
...
impl<'a> Iterator for ResolvedUserIter<'a> {
    type Item = (u32, Result<BranchOffset, RwasmError>);
