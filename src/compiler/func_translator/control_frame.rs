use crate::compiler::func_translator::labels::LabelRef;
...
impl BlockControlFrame {
    ...
    pub fn consume_fuel_instr(&self) -> Option<u32> {
        self.consume_fuel
    }
}
...
impl IfControlFrame {
    ...
    ///
    /// [`ConsumeFuel`]: enum.Instruction.html#variant.ConsumeFuel
    pub fn update_consume_fuel_instr(&mut self, instr: u32) {
        assert!(
