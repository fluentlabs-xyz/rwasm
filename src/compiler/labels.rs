...
/// A label during the `rwasm` compilation process.
...
/// The label registry.
///
/// Allows allocating new labels to pin them and resolve pinned ones.
...
impl LabelRegistry {
    ...
    /// Returns an iterator over pairs of users [`Instr`] and their [`BranchOffset`].
    ///
    /// # Panics
    ///
